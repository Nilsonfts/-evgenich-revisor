...
• `/gameover` - завершить смену досрочно (доступно только после окончания рабочего времени)
...
💡 *Голосовое сообщение во время паузы автоматически её завершает*
...
🏁 **ЗАВЕРШЕНИЕ СМЕНЫ:**
• `/gameover` - завершить смену досрочно (только после окончания рабочего времени)
💡 *Эта команда доступна только после официального времени окончания смены (например, после 04:00). 
Если вы выполнили план и хотите закончить работу после окончания смены - используйте эту команду для формирования финального отчета.*
...
🔹 **РАБОЧИЕ ДНИ (Вс-Чт):**
   🎤 1 КАРАОКЕ ВЕДУЩИЙ
   • Цель: 18 голосовых сообщений - по умолчанию
   • Ведет всю программу

🔸 **ВЫХОДНЫЕ ДНИ (Пт-Сб):**
   🎤 КАРАОКЕ ВЕДУЩИЙ - цель: 18 голосовых
   🎭 МС - цель: 17 голосовых по умолчанию  
...
⚙️ **АВТОМАТИЧЕСКОЕ НАЗНАЧЕНИЕ В ВЫХОДНЫЕ:**
• Кто записал ПЕРВОЕ голосовое = КАРАОКЕ ВЕДУЩИЙ
• Кто записал ВТОРОЕ голосовое = МС
• Альтернатива: `/start karaoke` и `/start МС`

💡 **КОМАНДЫ С РОЛЯМИ:**
• `/start` - автоматическое назначение
• `/startkaraoke` - начать как караоке ведущий  
• `/startmc` - начать как МС
