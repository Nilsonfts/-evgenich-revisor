# -*- coding: utf-8 -*-
"""
Финальная версия v11.0 (JSON + OpenAI):
...
def append_shift_to_google_sheet(chat_id, data, analytical_conclusion):
    ...
    row_data = [
        ...
        main_id, user_data['username'], user_data['count'], EXPECTED_VOICES_PER_SHIFT,
...
if __name__ == '__main__':
    logging.info("🤖 Бот (версия 11.0, JSON + OpenAI) запущен...")
